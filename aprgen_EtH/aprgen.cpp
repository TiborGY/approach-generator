...
int main(){
	std::array<uint32_t,1> frag2_idx = {8}; //atoms of the smaller reactant (count starts at 0)
	constexpr uint32_t NATOMS = 9; //total number of atoms
	...
	const std::string REF_GEOM_PATH = "ref_geom_eth_frad_rmp2_avdz_opt_qsd_4point.xyz"; //reference geometry with optimized free reactants
