...
int main(){
	std::array<uint32_t,2> frag2_idx = {4, 6}; //atoms of the smaller reactant (count starts at 0)
	...
	constexpr double PRUNING_THRESH = 0.025; //EW-RMSD pruning threshold for pruning too similar geometries
	const std::string REF_GEOM_PATH = "free_react_MeOH_OHrad_ManyHF_RMP2_AVDZ.xyz"; //reference geometry with optimized free reactants
